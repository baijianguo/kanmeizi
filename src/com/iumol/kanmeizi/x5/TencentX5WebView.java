...
public class TencentX5WebView extends WebView implements View.OnTouchListener {
	 ...
	 * paint.setTextSize(24.f); paint.setAntiAlias(true);
	 * if(getX5WebViewExtension() != null) canvas.drawText("X5 Core:" +
	 * WebView.getQQBrowserVersion(), 10, 50, paint); else
	 * canvas.drawText("Sys Core", 10, 50, paint); canvas.restore(); return ret;
	 * }
	 */
