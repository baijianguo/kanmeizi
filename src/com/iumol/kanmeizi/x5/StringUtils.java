...
public class StringUtils {
	...
	private static final Pattern URL_REGEX_PATTERN = Pattern
			.compile(REGEX_URL_PATTERN_STRING);
	...
	/**
	 * 转换字符串 1.将转义字符替换； 2.将特殊进制数值转换为十进制数值
	 * 
	 * @param text
	 */
		...
		while (iter < charArr.length) {
			...
			case TEXT_SPEC: {
				if (charArr[iter] == '#') {
					...
					/* &amp;转义为'&' */
					if (iter + 4 <= charArr.length
							&& (charArr[iter] == 'a' || charArr[iter] == 'A')
							&& (charArr[iter + 1] == 'm' || charArr[iter + 1] == 'M')
							&& (charArr[iter + 2] == 'p' || charArr[iter + 2] == 'P')
							&& charArr[iter + 3] == ';') {
						textBuffer.append("&");
						iter += 3;
					}
					/* &lt;转义为'<' */
					else if (iter + 3 <= charArr.length
							&& (charArr[iter] == 'l' || charArr[iter] == 'L')
							&& (charArr[iter + 1] == 't' || charArr[iter + 1] == 'T')
							&& charArr[iter + 2] == ';') {
						textBuffer.append("<");
						iter += 2;
					}
					...
					/* &apos;转义为''' */
							...
							&& (charArr[iter] == 'a' || charArr[iter] == 'A')
							&& (charArr[iter + 1] == 'p' || charArr[iter + 1] == 'P')
							&& (charArr[iter + 2] == 'o' || charArr[iter + 2] == 'O')
							&& (charArr[iter + 3] == 's' || charArr[iter + 3] == 'S')
							&& charArr[iter + 4] == ';') {
						textBuffer.append("'");
						iter += 4;
					}
					/* &quot;转义为'"' */
							...
							&& (charArr[iter] == 'q' || charArr[iter] == 'Q')
							&& (charArr[iter + 1] == 'u' || charArr[iter + 1] == 'U')
							&& (charArr[iter + 2] == 'o' || charArr[iter + 2] == 'O')
							&& (charArr[iter + 3] == 't' || charArr[iter + 3] == 'T')
							&& charArr[iter + 4] == ';') {
						textBuffer.append("\"");
						iter += 4;
					}
					/* &nbsp;转义为' ' */
							...
							&& (charArr[iter + 1] == 'b' || charArr[iter + 1] == 'B')
							&& (charArr[iter + 2] == 's' || charArr[iter + 2] == 'S')
							&& (charArr[iter + 3] == 'p' || charArr[iter + 3] == 'P')
							&& charArr[iter + 4] == ';') {
						textBuffer.append(" ");
						iter += 4;
					}
					/* &yen;转义为'￥' */
					else if (iter + 4 <= charArr.length
							&& (charArr[iter] == 'y' || charArr[iter] == 'Y')
							&& (charArr[iter + 1] == 'e' || charArr[iter + 1] == 'E')
							&& (charArr[iter + 2] == 'n' || charArr[iter + 2] == 'N')
							&& charArr[iter + 3] == ';') {
						textBuffer.append("￥");
						iter += 3;
					}
					/* &copy;转义为版权符号 */
							...
							&& (charArr[iter] == 'c' || charArr[iter] == 'C')
							&& (charArr[iter + 1] == 'o' || charArr[iter + 1] == 'O')
							&& (charArr[iter + 2] == 'p' || charArr[iter + 2] == 'P')
							&& (charArr[iter + 3] == 'y' || charArr[iter + 3] == 'Y')
							&& charArr[iter + 4] == ';') {
						textBuffer.append("\u00A9");
						iter += 4;
					}
					/* &ldquo;转义为中文左引号'“' */
							...
							&& //
							(charArr[iter] == 'l' || charArr[iter] == 'L')
							&& (charArr[iter + 1] == 'd' || charArr[iter + 1] == 'D')
							&& (charArr[iter + 2] == 'q' || charArr[iter + 2] == 'Q')
							&& (charArr[iter + 3] == 'u' || charArr[iter + 3] == 'U')
							&& (charArr[iter + 4] == 'o' || charArr[iter + 4] == 'O')
							&& (charArr[iter + 5] == ';')) {
						textBuffer.append("“");
						iter += 5;
					}
					...
					/* &uarr;转义为'↑' */
							...
							&& (charArr[iter + 1] == 'a' || charArr[iter + 1] == 'A')
							&& (charArr[iter + 2] == 'r' || charArr[iter + 2] == 'R')
							&& (charArr[iter + 3] == 'r' || charArr[iter + 3] == 'R')
							&& (charArr[iter + 4] == ';')) {
						textBuffer.append("↑");
						iter += 4;
					}
					...
					/* &trade;转义为版权TM标志 */
							...
							&& (charArr[iter + 1] == 'r' || charArr[iter + 1] == 'R')
							&& (charArr[iter + 2] == 'a' || charArr[iter + 2] == 'A')
							&& (charArr[iter + 3] == 'd' || charArr[iter + 3] == 'D')
							&& (charArr[iter + 4] == 'e' || charArr[iter + 4] == 'E')
							&& (charArr[iter + 5] == ';')) {
						textBuffer.append("\u8482");
						iter += 5;
					}
					/* &ndash;转义为'–' */
							...
							&& (charArr[iter + 2] == 'a' || charArr[iter + 2] == 'A')
							&& (charArr[iter + 3] == 's' || charArr[iter + 3] == 'S')
							&& (charArr[iter + 4] == 'h' || charArr[iter + 4] == 'H')
							&& (charArr[iter + 5] == ';')) {
						textBuffer.append("–");
						iter += 5;
					}
					...
					/* &rsaquo;转化为U+203A */
							...
							&& (charArr[iter] == 'r' || charArr[iter] == 'R')//
							&& (charArr[iter + 1] == 's' || charArr[iter + 1] == 'S')
							&& (charArr[iter + 2] == 'a' || charArr[iter + 2] == 'A')
							&& (charArr[iter + 3] == 'q' || charArr[iter + 3] == 'Q')
							&& (charArr[iter + 4] == 'u' || charArr[iter + 4] == 'U')
							&& (charArr[iter + 5] == 'o' || charArr[iter + 5] == 'O')
							&& (charArr[iter + 6] == ';')) {
						textBuffer.append("\u203A");
						iter += 6;
					} else {
			...
			case TEXT_DEC: {
				if (charArr[iter] <= '9' && charArr[iter] >= '0'
						&& digitalCount++ < 5) {
					/* 最大值65536 */
					// TODO:为什么需要限制最大值？
			...
			case TEXT_HEX: {
				if (charArr[iter] <= '9' && charArr[iter] >= '0'
						&& digitalCount++ < 4) { // 16,max=65535
					value = value * 16 + (charArr[iter] - '0');
				} else if (charArr[iter] <= 'F' && charArr[iter] >= 'A'
						&& digitalCount++ < 4) {
			...
			case TEXT_OCTAL:// 八进制
				if (charArr[iter] <= '7' && charArr[iter] >= '0'
						&& digitalCount++ < 8) { // 8,max=65535
			...
			case TEXT_BLOCK:
				/* 空格，包括普通空格，'\r' '\n'以及制表符 */
				if (charArr[iter] != 0x20 && charArr[iter] != 0x0D
						&& charArr[iter] != 0x0A && charArr[iter] != 0x09) {
					type = TEXT_COMMON;
					iter--;
				}
				break;
	 ...
	 * @return 替换后的串
	 */
	public static String replace(String targetString, String matcher,
			String newText) {
	 ...
	 *            颜色
	 */
	public static void replaceAndDye(SpannableStringBuilder ssb,
			String wildcard, String dyedString, int color) {
	...
	public static String getSizeStringByPrecision(float size, int precision) {
		if (size < 0 || precision < 0) {
			...
			return String.format((new StringBuilder()).append(SIZE_PREFIX)
					.append(precision).append(SIZE_KB_POSTFIX).toString(), size
					/ K);
		} else if (size < G) {
			return String.format((new StringBuilder()).append(SIZE_PREFIX)
					.append(precision).append(SIZE_MB_POSTFIX).toString(), size
					/ M);
		} else {
			return String.format((new StringBuilder()).append(SIZE_PREFIX)
					.append(precision).append(SIZE_GB_POSTFIX).toString(), size
					/ G);
		}
	}
	...
	public static String formatDownloadCount(long count) {
		if (count < 0) {
			...
			return String
					.format(TIMES_MILLION, (float) count / (10000 * 10000));
		}
	}
	...
	public static String getSignificantFigure(float number, int digit) {
		...
		return str.substring(0, (integerNumber < digit) ? digit + 1
				: integerNumber);
	}
	...
	/**
	 * 根据paint，width，截断text levijiang 2011-07-15
	 * 
	 * @param text
	 * @param paint
	 * @param width
	...
	public static String[] getAttributeFromTagA(String content) {
		if (isEmpty(content) || !content.contains("<a")
				|| !content.contains("/a>"))
			return null;
	...
	/**
	 * add by damon 将System.currentTimeMillis() 转化成format( 例如MM月dd日 HH:mm）
	 * 
	 * @param time
	 * @return
	 */
	...
	/**
	 * 从网页内容中取出其CSS 的url地址 支持link与import方式
	 * 
	 * @param content
	 * @return
	 */
	...
	/*
	 * Copyright (C) 2005-2010 TENCENT Inc.All Rights Reserved.
	 * FileName：NumberFormatter.java Description： History： 1.0 samuelmo Jun 18,
	 * 2010 Create
	 */
		...
		for (int i = 0;; i++) {
			...
			if (sa.length() == i)
				...
				if (me && !a)
					...
					return Collator.getInstance().compare(sa.substring(i),
							sb.substring(i));
			}
		}
	}
