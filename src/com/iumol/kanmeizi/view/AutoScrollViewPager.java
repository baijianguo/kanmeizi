...
public class AutoScrollViewPager extends ViewPager {
	...
	public static final int DEFAULT_INTERVAL = 2 * 1000;
	...
	private onItemClickAutoScrollViewPagerListener clicklistener;
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		if (ev.getAction() == MotionEvent.ACTION_DOWN) {
			...
			if (startX == currentX && null != clicklistener)
				clicklistener.onClickItem(getCurrentItem());
		}
	...
	public void setClickPageListener(
			onItemClickAutoScrollViewPagerListener listener) {
		clicklistener = listener;
	}

	public interface onItemClickAutoScrollViewPagerListener {
