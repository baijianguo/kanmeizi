...
public class ImageClass {
	...
	public static String[][] MztImageInfo = {
			...
			{ "淘宝女郎", "http://www.taobao.com/market/mm/tnlmmt.php" },
	...
	public static int[] imageDrawable = { R.drawable.gengduo, R.drawable.weibo,
			R.drawable.taonvlang, R.drawable.douban, R.drawable.jiepai,
			R.drawable.bijini, R.drawable.yougou, R.drawable.wangluo,
			R.drawable.xiaohua, R.drawable.xiaoqingxin, R.drawable.mengmeizi,
			R.drawable.zipai };
