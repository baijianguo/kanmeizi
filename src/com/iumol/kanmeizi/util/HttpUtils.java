...
public class HttpUtils {
	...
	public static String httpGetStringPcAgent(String httpUrl) {
		HttpRequest hp = new HttpRequest(httpUrl);
		hp.setUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_6_8) AppleWebKit/535.7 (KHTML, like Gecko) Chrome/16.0.912.75 Safari/535.7");
		HttpResponse response = httpGet(hp);
		return response == null ? null : response.getResponseBody();
	}
