...
import com.iumol.kanmeizi.entity.CacheObject;
import com.iumol.kanmeizi.entity.FailedReason;
import com.iumol.kanmeizi.service.impl.FileNameRuleImageUrl;
import com.iumol.kanmeizi.service.impl.ImageCache;
import com.iumol.kanmeizi.service.impl.ImageSDCardCache;
import com.iumol.kanmeizi.service.impl.RemoveTypeLastUsedTimeFirst;
import com.iumol.kanmeizi.service.impl.ImageMemoryCache.OnImageCallbackListener;
import com.iumol.kanmeizi.service.impl.ImageSDCardCache.OnImageSDCallbackListener;
import com.iumol.kanmeizi.service.impl.PreloadDataCache.OnGetDataListener;
			...
			public void onGetSuccess(String imageUrl, Bitmap loadedImage,
				...
				if (view != null && loadedImage != null) {
					if (view instanceof ImageView) {
						...
						if (!isInCache) {
							imageView.startAnimation(getInAlphaAnimation(500));
						}
					} else {
						Log.e(TAG,
